...
public class FakerPDFService: IPDFService
{
    private readonly IFileOperationService fileOperationService;
    private readonly IConverter converter;
    private readonly IImageService imageService;

    public FakerPDFService(IFileOperationService fileOperationService, IConverter converter, IImageService imageService)
    {
