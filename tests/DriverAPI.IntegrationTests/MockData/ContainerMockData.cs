...
public class ContainerMockData: UserMockData
{
    ...
    public ContainerRequest GetContainerRequest(string LegType = LegTypes.PICKUP)
    {
    ...
    public DocumentSubmitRequest GetDocumentSubmitRequest(int ProNumber, string LegType = LegTypes.PICKUP_MT)
    {
        this.ImagesInBase64 = GetPODImageAsString();
